...
import (
	...
	"github.com/wuntsong-org/go-zero-plus/tools/goctlwt/api/parser/g4/ast"
	...
	apiParser "github.com/wuntsong-org/go-zero-plus/tools/goctlwt/pkg/parser/api/parser"
)
