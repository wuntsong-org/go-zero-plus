...
import (
	...
	"github.com/wuntsong-org/go-zero-plus/tools/goctlwt/example/rpc/hello/internal/config"
	greetServer "github.com/wuntsong-org/go-zero-plus/tools/goctlwt/example/rpc/hello/internal/server/greet"
